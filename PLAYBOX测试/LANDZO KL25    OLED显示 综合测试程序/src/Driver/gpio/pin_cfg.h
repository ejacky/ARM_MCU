...
#define TPM0_CH4    PTC8         //PTE31、PTD8
#define TPM0_CH5    PTC9         //PTD9、PTA0、PTC9            PTA0不要用（与Jtag、SWD冲突）
...
//      模块通道    端口          可选范围              
#define TPM2_CH0    PTB18        //PTE22、PTB2、PTB18、PTA1
#define TPM2_CH1    PTB19        //PTE23、PTB3、PTB19、PTA2
